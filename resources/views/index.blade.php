            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
                    <div class="hero-text">
                        ...
                        <a href="{{ route('contact') }}" class="custom-btn btn-bg btn mt-3" data-aos="fade-up"
            ...
            <div class="row">
                ...
                <div class="col-lg-7 mx-auto col-md-10 col-12">
                    <div class="about-info">
                        ...
                        <h2 class="mb-4" data-aos="fade-up">the best <strong>Digital Marketing agency</strong> in
                            Rio de Janeiro</h2>
                        ...
                        <p class="mb-0" data-aos="fade-up">Total 5 HTML pages are included in this template from
                            TemplateMo website. Please check 2 <a href="blog.html">blog</a> pages, <a
                                href="project-detail.html">project</a> page, and <a href="contact.html">contact</a> page.
